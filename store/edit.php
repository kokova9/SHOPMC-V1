  ...
  <div class="row">
    <div class="col-2">
      <div class="list-group">
         ...
         <a href="edit.php" class="list-group-item list-group-item-action active">แก้ไขสินค้าที่ลงขาย</a>
...
?>
    <?php 
        ...
        $sql = "select * from item_list where useradd = '$user' limit {$start} , {$perpage}";
    ...
    ?>
        <div class="col-md-3">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text" style="height:60px;"><?=$result['name']?></p>
              <div class="d-flex justify-content-between align-items-center" style="margin-top:20px">
                <div class="btn-group">
                  <a type="button" class="btn btn-warning" href="edit.php?id=<?=$result['id']?>">Edit</a>
                </div>
                <a type="button" class="btn btn-danger" href="system/deleteitem.php?id=<?=$result['id']?>">Delete</a>
              </div>
              </div>
            </div>
          </div>  
...
<div class="btn-group me-2" role="group" aria-label="First group">
  ...
  if($page == $i) {
  ?>
    <a href="edit.php?page=<?php echo $i; ?>" class="text-decoration-none btn btn-primary disabled" style="color:white;"><?php echo $i; ?></a>
  </div>
  <div class="btn-group me-2" role="group" aria-label="First group">
  <?php }else{ ?>
    <a href="edit.php?page=<?php echo $i; ?>" class="text-decoration-none btn btn-primary" style="color:white;"><?php echo $i; ?></a>
 </div>
 <?php 
  }
  } 
...
<?php
    ...
    $result = mysqli_fetch_array($query);
?>
  <form class="px-4 py-3" method="POST" action="system/edititem.php?id=<?=$result['id']?>">
  <?php
  ?>
    <div class="mb-3">
      <label for="exampleDropdownFormEmail1" class="form-label">Itemname</label>
      <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="Itemname" name="itemname" value="<?=$result['name']?>">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Picture link</label>
      <input type="text" class="form-control" id="exampleDropdownFormPassword1" placeholder="Picturelink" name="picturelink" value="<?=$result['img']?>">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Detail</label>
      <input type="text" class="form-control" id="exampleDropdownFormPassword1" placeholder="Detail" name="detail" value="<?=$result['detail']?>">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Price per item</label>
      <input type="number" class="form-control" id="exampleDropdownFormPassword1" placeholder="Price per item" name="price" value="<?=$result['price']?>">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Stock amount</label>
      <input type="number" class="form-control" id="exampleDropdownFormPassword1" placeholder="Stock amount" name="stock" value="<?=$result['stock']?>">
    </div>
    <button type="submit" class="btn btn-warning" name="edit_item">Edit item</button>
  </form>
