...
<div class="container">
  <div class="row">
    <div class="col-2">
      <div class="list-group">
         <a href="index.php" class="list-group-item list-group-item-action active">เพิ่มสินค้าลงขาย</a>
  ...
  <div class="col-9">
  <form class="px-4 py-3" method="POST" action="system/additem.php">
    <div class="mb-3">
      <label for="exampleDropdownFormEmail1" class="form-label">Itemname</label>
      <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="Itemname" name="itemname">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Picture link</label>
      <input type="text" class="form-control" id="exampleDropdownFormPassword1" placeholder="Picturelink" name="picturelink">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Detail</label>
      <input type="text" class="form-control" id="exampleDropdownFormPassword1" placeholder="Detail" name="detail">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Price per item</label>
      <input type="number" class="form-control" id="exampleDropdownFormPassword1" placeholder="Price per item" name="price">
    </div>
    <div class="mb-3">
      <label for="exampleDropdownFormPassword1" class="form-label">Stock amount</label>
      <input type="number" class="form-control" id="exampleDropdownFormPassword1" placeholder="Stock amount" name="stock">
    </div>
