  ...
  <div class="row">
    <div class="col-2">
      <div class="list-group">
         ...
         <a href="buying.php" class="list-group-item list-group-item-action active">จัดการคำสั่งซื้อ</a>
         <?php 
  ...
  ?>
    ...
    <div class="mb-3">
      ...
      <select name="tracking" id="track" onchange="change()">
          ...
          <option value="sendsuc">ขนส่งรับพัสดุเรียบร้อย</option>
          <option value="suc">ส่งแล้ว</option>
      </select>
    </div>
    <div class="mb-3">
